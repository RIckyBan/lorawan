...
#ifndef CUSTOM_PERIODIC_SENDER_H
#define CUSTOM_PERIODIC_SENDER_H
...
class CustomPeriodicSender : public Application
{
public:
  CustomPeriodicSender ();
  ~CustomPeriodicSender ();
  ...
  void InitOffset (uint32_t node_id);

  std::string ReadOffset(uint32_t node_id);
